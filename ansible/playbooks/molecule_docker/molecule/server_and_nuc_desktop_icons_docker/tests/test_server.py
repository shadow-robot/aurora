...
def test_icons_in_docker(host):
    ...
    icons = (
        ...
        'Shadow Demos/Close Bimanual Hand',
        'Shadow Demos/Demo Bimanual Hand',
        'Shadow Demos/Open Bimanual Hand',
        'Shadow Demos/Biotacs Demo Bimanual Hand',
