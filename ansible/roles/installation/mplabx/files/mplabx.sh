...
wget https://s3.eu-west-2.amazonaws.com/com.shadowrobot.eu-west-2.public/public_aurora_files/MPLABX-v5.45-linux-installer.run /home/user/Desktop/
...
wait
sudo rm /home/user/Desktop/MPLABX-v5.45-linux-installer.run
